...
public class SSLServer implements Runnable{
    ...
    public void init() {
        try {
            ...
            ks.load(new FileInputStream("src/key/kserver.keystore"), SERVER_KEY_STORE_PASSWORD.toCharArray());
            tks.load(new FileInputStream("src/key/tserver.keystore"), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());
